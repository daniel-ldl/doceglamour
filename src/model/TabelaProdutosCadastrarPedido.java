 ...
 * @author joao
 */
public class TabelaProdutosCadastrarPedido extends AbstractTableModel{
    
    private List<Produto> produto = new ArrayList<>();
    private String [] colunas = {"PRODUTO", "QUANTIDADE", "VALOR UNITARIO", "VALOR TOTAL"};

    public TabelaProdutosCadastrarPedido() {
    }
    ...
    public TabelaProdutosCadastrarPedido(List <Produto> produto) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch(columnIndex){
            ...
            case 3:
                return produto.get(rowIndex).getValorFinal();
            default:
                return null;
